...
interface AnsweringCardProps {
  ...
  onQuestionChange: (index: number, data: any) => void;
  initialData?: {
    id?: number | string;
    type?: string;
...
const AnsweringCard = memo(
  ({ questionIndex, onQuestionChange, initialData }: AnsweringCardProps) => {
    ...
    const notifyChange = (newData: any) => {
    ...
    const handleCorrectAnswerChange = (
      ...
      if (questionType === "multiple-choice") {
        ...
        if (currentAnswers.includes(selectedValue)) {
          newCorrectAnswer = currentAnswers
    ...
    return (
      ...
      >
        ...
        >
          <MenuItem sx={{ fontSize: "1.4rem" }} value="single-choice">
            1 đáp án
          </MenuItem>
          <MenuItem sx={{ fontSize: "1.4rem" }} value="multiple-choice">
            Nhiều đáp án
          </MenuItem>
          <MenuItem sx={{ fontSize: "1.4rem" }} value="long-response">
            Tự luận
          </MenuItem>
        </Select>
